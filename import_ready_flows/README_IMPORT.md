...
| ---: | --- | --- | ---: | ---: |
| 1 | `01_data_analysis_flow_v5_standalone.json` | `metadata-driven-v5-complete-20260710-data-analysis` | 42 | 66 |
...
- Langflow 1.8.2 frontend edge handle codec: 290/290 parse 및 `edge.data` 일치
