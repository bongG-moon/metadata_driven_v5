...
| 8 | `08_agent_orchestrator_router_flow_v5_standalone.json` | `metadata-driven-v5-complete-20260710-agent-orchestrator-router` | 8 | 7 |
| 9 | `09_workflow_orchestrator_flow_v5_standalone.json` | `metadata-driven-v5-complete-20260710-workflow-orchestrator` | 17 | 25 |
| 10 | `10_workflow_skill_saving_flow_v5_standalone.json` | `metadata-driven-v5-complete-20260710-workflow-skill-saving` | 13 | 14 |
...
- Langflow 1.8.2 frontend edge handle codec: 384/384 parse 및 `edge.data` 일치
