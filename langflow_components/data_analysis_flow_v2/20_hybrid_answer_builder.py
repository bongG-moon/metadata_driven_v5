    ...
    return _omit_empty(
        {
            ...
            # Intermediate checkpoints are rendered by the message adapter
            # only when its display option is enabled.  They are deliberately
            # kept out of the answer-model evidence variables to avoid token
            # growth.
