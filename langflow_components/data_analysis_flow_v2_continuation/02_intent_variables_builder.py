    ...
    return {
        "intent_plan": {
            ...
            "pandas_execution_plan": [
                {
                    ...
                    "operation": "apply_filters|select_columns|groupby_and_aggregate|sort_and_top_n|count_rows|value_counts|distinct_values|latest_earliest|select_extreme_row_per_group|percent_of_total|rank_within_group|threshold_after_aggregate|time_bucket_summary|period_change|running_total|moving_aggregate|percentile_summary|pivot_summary|join|compare_presence|compare_group_attributes|find_duplicate_groups|apply_row_match_groups|apply_pandas_function_case",
                    "inputs": [
                        {
                    ...
                    "order": "asc|desc",
                    "limit": 0,
                    "partition_by": ["group key for select_extreme_row_per_group"],
                    "order_by": [{"column": "canonical order column", "direction": "asc|desc"}],
                    "tie_breakers": [{"column": "canonical tie breaker", "direction": "asc|desc"}],
                    "limit_per_group": 1,
                    "tie_policy": "first|include_all|error",
                    "projection": ["columns preserved from the same winning row"],
                    "strict": True,
                    "calculation": {
                        "partition_by": [],
                        "order_by": [],
                        ...
                        "time_column": "시간 기준 canonical 컬럼",
                        "time_bucket_column": "시간 구간 결과 컬럼",
                        "frequency": "day|week|month|quarter|year",
                        "timezone": "선택 timezone",
                        "closed": "left|right",
                        "label": "left|right",
                        "periods": 1,
                        "change_method": "difference|percent",
                        "window": 0,
                        "min_periods": 1,
                        "percentile": 0.5,
                        "percentile_method": "continuous|discrete",
                        "output_column": "계산 결과 canonical 출력 컬럼",
                        "quality_check": "null_count|blank_count|duplicate_count|null_rate|duplicate_rate",
                        "quality_columns": [],
                        "duplicate_policy": "all_rows|excess_rows",
                        "threshold_column": "집계 후 비교할 결과 컬럼",
                        "threshold_operator": "gt|ge|lt|le|eq|ne",
                        "threshold_value": "비교값",
                        "pivot_index": [],
                        "pivot_columns": [],
                        "pivot_values": [],
            ...
            "output_contract": {
                ...
                "fast_path_recipe": "선택 사항: 정규화된 범용 recipe 이름",
                "calculation": {},
                "column_labels": {
