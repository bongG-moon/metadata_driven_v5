...
def load_table_catalog_metadata(
    ...
    if not config["mongo_uri"]:
        return _result("skipped", [], config, status_filter, [{"type": "missing_mongo_uri", "message": "MONGODB_URI가 없어 테이블 카탈로그를 불러오지 않았습니다."}])
    ...
    try:
        ...
        projection = {"_id": 0, "dataset_key": 1, "key": 1, "status": 1, "payload": 1}
