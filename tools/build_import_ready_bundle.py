...
def build_bundle(output_dir: Path) -> dict[str, Any]:
    ...
    manifest = {
        ...
        "validation": {
            "pytest": "418/418 non-web tests passed in the exact Langflow 1.9.2 runtime; 21 optional Streamlit web-app tests require the separate web runtime",
            ...
            "korean_component_documentation": "87/87 Python sources and 1669/1669 function definitions documented; 37 component text sources and 11 embedded prompts are BOM-free; 378 embedded custom-code instances preserve 7812/7812 documented function instances; strict UTF-8/JSON checks passed",
...
- Langflow/Flow 비웹 pytest: 418/418 passed (별도 Streamlit 웹 런타임용 21개 테스트는 제외)
