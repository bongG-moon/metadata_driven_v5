...
- `langflow_components` Python: 70개 전체
- 활성 Custom Component 원본: 69개
...
- 한글 설명 주석: Python 70/70
- 함수별 인접 설명: 1119/1119
- Python strict UTF-8 decode: 70/70
- UTF-8 BOM: 0건
- 깨짐 대체문자·NUL: 0건
- Python AST/compile: 70/70
- 컴포넌트 Markdown strict UTF-8/BOM 검사: 26/26
- 내장 Prompt 원본과 JSON 3계층 exact match: 9/9
- 현재 JSON strict UTF-8/parse: 16/16
- JSON 내장 Custom Component 코드 검사: 234건
- JSON 내장 함수별 설명 검사: 3,699/3,699
- Python 원본과 JSON source sync: export·개별 import·통합 bundle 각각 78/78
- 비활성 Python: 0개
